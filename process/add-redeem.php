<?php
	...
	include_once("../core/class.functions.inc.php");
    if (!admin::isSession()) {
		...
		echo $payout_name."-".$payout_sub."-".$payout_image_name."-".$payout_amount."-".$payout_points."-".$payout_msg;
		$urlfinal = curPageURL()."/images/";
		//payout_image
