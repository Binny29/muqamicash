...
class account extends db_connect
{
    ...
    public function signup($username, $fullname, $password, $email, $country)
    {
        ...
        $stmt = $this->db->prepare("INSERT INTO users (state, login, fullname, passw, email, salt, regtime, ip_addr, country) value (:state, :username, :fullname, :password, :email, :salt, :createAt, :ip_addr, :country)");
    ...
    public function restorePointCreate($email, $clientId)
    {
        ...
        $stmt = $this->db->prepare("INSERT INTO restore_data (accountId, hash, email, clientId, createAt, u_agent, ip_addr, country) value (:accountId, :hash, :email, :clientId, :createAt, :u_agent, :ip_addr, :country)");
        $stmt->bindParam(":accountId", $this->id, PDO::PARAM_INT);
