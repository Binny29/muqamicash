 ...
 */
    ...
    if (admin::isSession()) {
        ...
        header("Location: http://localhost/muqamicash/admin.php");
    }
    ...
    include_once($_SERVER['DOCUMENT_ROOT']."/muqamicash/common/header.inc.php");
...
<body style="background-color: transparent; background-image: none">
    ...
    <div id="page_wrap">
        ...
        <?php
            ...
            include_once($_SERVER['DOCUMENT_ROOT']."/muqamicash/common/admin_panel_topbar.inc.php");
        ?>
        ...
        <div id="page_layout">
            ...
            <?php
                ...
                include_once($_SERVER['DOCUMENT_ROOT']."/muqamicash/common/admin_panel_banner.inc.php");
            ?>
            ...
            <div id="page_auth">
                ...
                <div class="frm">
                    <form action="http://localhost/muqamicash/admin/login.php" method="post" id="login_form">
            ...
            <?php
                ...
                include_once($_SERVER['DOCUMENT_ROOT']."/muqamicash/common/admin_panel_footer.inc.php");
            ?>
